...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.20]{OriginalMNIST.png}
	\includegraphics[scale=0.20]{Sigma=1e-2,Alpha=8.png}
	\includegraphics[scale=0.20]{Sigma=3,Alpha=8.png}
	\includegraphics[scale=0.20]{Sigma=3,Alpha=30.png}
