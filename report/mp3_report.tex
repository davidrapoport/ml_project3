...
An epoch is one forward pass and backpropagation event.
ROC (?) curves are shown in \ref{CNNacc}
...
Next steps involve investigation into a Spatial Transformer Network \cite{STN}
